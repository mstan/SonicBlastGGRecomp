# build.ps1 — regenerate + build SonicBlastGGRecomp (windowed) from your ROM.
#
# Requires:
...
#
# Usage:  powershell -File build.ps1 [-Rom sonicblast.gg] [-Sdl C:\msys64\mingw64] [-SkipRegenerate]
param(
    [string]$Rom = "sonicblast.gg",
...
Write-Host "Done: $out  (run: .\$out $Rom --window 4)"
